...
epochs = 10
alpha, beta, gamma = 0.025, 1.0, 1.2
content_img_path = 'contents/content.jpg'
style_img_path = 'styles/art7.jpg'
...
for i in range(epochs):
	print('\rEpoch {0:>3}'.format('#' + str(i + 1)))
	start_time = time()
	x, min_val, info = fmin_l_bfgs_b(e.loss, x.flatten(),fprime=e.grads, maxfun=20)
	print('Current Loss: {0:10.3e}'.format(min_val))
	x = x.reshape((1, nrows, ncols, 3))
